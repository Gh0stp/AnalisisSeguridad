...
{
	constexpr intrusive_node() noexcept
		: prev_(this)
		, next_(this)
	{}
	...
	friend void swap(intrusive_node &lhs, intrusive_node &rhs) noexcept
	{
		using std::swap;
...
struct intrusive_list
{
	...
	{
		intrusive_list copy(std::move(rhs));
