...
engine<AnyMessage>::server::server(fz::tcp::server::context &context, dispatcher &dispatcher, logger_interface &logger, fz::tcp::listener::status_change_notifier &scn)
...
template <typename AnyMessage>
void engine<AnyMessage>::server::listener_status_changed(const fz::tcp::listener &listener)
{
	scn_.listener_status_changed(listener);
};
